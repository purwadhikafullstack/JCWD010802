...
export const ProductCard = ({ name, price, image, category, onClick, isLoaded }) => {
  return (
      ...
      <Flex onClick={onClick}>
        ...
        >
          ...
          <Box>
            ...
            <Text fontSize="14px" maxW="160px" whiteSpace="nowrap" textOverflow="ellipsis" overflow="hidden"> 
              {name}
            </Text>
